...
export default class HomeScreen extends Component {
    ...
    getArticle = () => {
        const url = "https://89f7-106-212-226-20.in.ngrok.io/get-article" //Providing Ngrok URL
        axios
            .get(url)
            .then(response => {
    ...
    likedArticle = () =>{
        const url = "https://89f7-106-212-226-20.in.ngrok.io/liked-article";
        axios
            .post(url)
            .then(response => {
                this.getArticle();
    ...
    unlikedArticle = () =>{
        const url = "https://89f7-106-212-226-20.in.ngrok.io/unliked-article";
        axios
            .post(url)
            .then(response => {
                this.getArticle();
